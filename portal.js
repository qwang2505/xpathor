...
var PortalProcessor = Processor.extend({
	...
	_category_selection: '<select class="xpathor-dialog-select"><option value="-1" selected>------</option><option value="1">Important News</option>' + 
						...
						'<option value="18">Politics</option><option value="27">Beauty</option><option value="20">Fashion</option>' + 
						'<option value="35">Health</option><option value="40">Emotion</option><option value="41">Food</option></select>',
